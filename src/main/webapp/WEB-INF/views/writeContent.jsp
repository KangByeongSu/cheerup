...
<body>
	...
	<div class="upload-header">
		 <span class="upload-header-text">Instagram
			Upload</span>
	</div>
	...
	<div class="upload-content">
			...
			<div class="content">
				...
				<div class="box">
					<form name="uploadForm" action="javascript:imageUploadAjax();"
						...
						<input onchange="readURL(this);" type="file" name="imageFile" id="file-2"
							class="inputfile inputfile-2"  /> <label
		...
		<div class="upload-content-text">
			...
			<textarea name="styled-textarea" id="styled"
				onfocus="this.value=''; setbg('#e5fff3');" onblur="setbg('white')">사진과 어울리는 문구를 작성해주세요.</textarea>
		</div>
	</div>
	<div class="upload-footer">
		<div class="upload-footer-text">SK플래닛 Team Elephant</div>
		<div class="upload-footer-post">
			<form name="textUploadForm" action="./uploadText" method="post"  enctype="multipart/form-data">
				<img id=submitText
					src=<c:url value='/resources/img/post-button.png' /> />
			</form>
		</div>
	</div>
	<section> <script
